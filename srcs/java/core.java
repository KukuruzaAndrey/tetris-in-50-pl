...
class SmallBoard {
    ...
    public SmallBoard() {
        this.nextFigIndex = BoardFigure.getNextFigIndex();
        this.nextFigColor = BoardFigure.getNextFigColor();
        this.score = 0;
...
class Board {
    ...
    public String render(BoardFigure bf, SmallBoard sb) {
        StringBuffer res = new StringBuffer();
        addFigure(bf);
...
class Game {
    ...
    public String getNextState() {
        return String.format("%d %s %s %s", move.ordinal(), board, bf, sb);
    }
    ...
    public Game(String[] args) {
        ...
        sb = new SmallBoard(Integer.parseInt(args[7]), Integer.parseInt(args[8]), Integer.parseInt(args[9]));
    }
